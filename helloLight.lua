...
function TIC()
	...
	if btn(4) and gi<8 then gi=gi+1 end
	...
	print("GI:" .. gi, 54, 2)
	print("FPS:"..math.floor(fps), 54, 12, 6)
end
...
function drawShadow()
	...
	for scnline=0,136 do
		...
		for i=0,238,2 do
			...
			local shadeAmount2= (lr_m - r2*lf_m) // 1
